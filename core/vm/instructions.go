...
func opBalance(pc *uint64, interpreter *EVMInterpreter, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	slot := stack.peek()
	slot.Set(interpreter.evm.StateDB.GetBalance(common.BigToAddress(slot), types.DefaultCurrency))
	return nil, nil
}
...
func opSuicide(pc *uint64, interpreter *EVMInterpreter, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	balance := interpreter.evm.StateDB.GetBalance(contract.Address(), types.DefaultCurrency)
	interpreter.evm.StateDB.AddBalance(common.BigToAddress(stack.pop()), types.DefaultCurrency, balance)
