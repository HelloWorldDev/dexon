...
var (
	...
	// TestnetChainConfig contains the chain parameters to run a node on the DEXON test network.
	...
	TestChainConfig = &ChainConfig{big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, new(EthashConfig), nil, &DexconConfig{BlockReward: big.NewInt(1)}}
